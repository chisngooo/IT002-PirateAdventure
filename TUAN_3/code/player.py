...
class Player(pygame.sprite.Sprite):
    ...
    def get_damage(self):
        '''
        Xử lý khi nhân vật nhận sát thương
        '''
    ...
    def flicker(self):
        '''
        Tạo hiệu ứng nhấp nháy cho nhân vật khi nhân vật nhận sát thương, trong thời gian này nhân vật sẽ không nhận sát thương nữa
        '''
