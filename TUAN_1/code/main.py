...
class Game:
    ...
    def show_menu(self):
        ...
        while True:
            ...
            if not self.showing_tutorial:
                self.display_surface.blit(self.tmx_maps['menu'], (0, 0))
                ...
                self.display_surface.blit(self.tmx_maps['tutorial'], (0, 0))
    ...
    def draw_button(self, text, button):
        ...
        # Tạo hiệu ứng đậm hơn cho font chữ (Font chữ nét hơi nhỏ so với kiểu em thích)
